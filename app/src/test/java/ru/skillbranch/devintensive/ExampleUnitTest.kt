...
class ExampleUnitTest {
    ...
    fun test_of_humanizeDiff() {
        ...
        // ----- Future ------
//        assertEquals( "только что", Date().add(1, TimeUnits.SECOND).humanizeDiff()  )
//        assertEquals( "через 1 минуту", Date().add(1, TimeUnits.MINUTE).humanizeDiff()  )
...
//        assertEquals( "через 1 час", Date().add(1, TimeUnits.HOUR).humanizeDiff()  )
...
//        assertEquals( "через 1 день", Date().add(1, TimeUnits.DAY).humanizeDiff() )
...
//        assertEquals( "через год", Date().add(400, TimeUnits.DAY).humanizeDiff()  )
    }
